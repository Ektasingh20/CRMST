...
export default function StudentDashboard() {
  ...
  const handleNav = (id) => {
    setActiveNav(id);
    setMobileOpen(false);
    if (id === "logout") showToast("Logged out (demo only — this is a prototype).");
  };
      ...
      <div style={{ display: "flex" }}>
        ...
        <aside className={`sd-sidebar${mobileOpen ? " open" : ""}`} style={{
          ...
          <div style={{ borderTop: `1px solid ${C.sidebarBorder}`, padding: "14px 16px 16px", display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }} onClick={() => handleNav("profile")}>
            <div style={{ width: 34, height: 34, borderRadius: "50%", background: C.accent, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 12.5, flexShrink: 0 }}>RS</div>
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: 12.8, fontWeight: 700, color: C.sidebarTextBright, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>Riya Sharma</div>
          ...
          <header style={{ background: C.card, borderBottom: `1px solid ${C.border}`, padding: "14px 28px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 50 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14, position: "relative" }}>
              ...
              <div onClick={() => handleNav("profile")} style={{ display: "flex", alignItems: "center", gap: 9, padding: "4px 10px 4px 4px", border: `1px solid ${C.border}`, borderRadius: 24, cursor: "pointer" }}>
                <div style={{ width: 28, height: 28, borderRadius: "50%", background: C.badgeBg, color: C.badgeIcon, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 12 }}>RS</div>
                <div style={{ lineHeight: 1.2 }}>
                  <div style={{ fontSize: 12.5, fontWeight: 700 }}>Riya Sharma</div>
            ...
            {activeNav === "profile" && (
              <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 18, padding: 26, maxWidth: 480, boxShadow: "0 1px 2px rgba(33,28,46,0.03), 0 4px 14px rgba(33,28,46,0.04)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 20 }}>
                  <div style={{ width: 56, height: 56, borderRadius: "50%", background: C.accent, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 18 }}>RS</div>
                  <div>
                    <div style={{ fontSize: 16, fontWeight: 700 }}>Riya Sharma</div>
                    <div style={{ fontSize: 12.5, color: C.textSecondary }}>Student · Batch of 2026</div>
                  </div>
                </div>
                {[["Email", "riya.sharma@example.com"], ["Enrolled Courses", `${enrolledCourses.length} courses`], ["Member Since", "Jan 2026"]].map(([k, v]) => (
